...
# Set wd -------------------------------------------------------------------
setwd("/Users/sar/Dropbox/Dallas2K/PhyloseqV3/Paper_v2/aldex")


# Setup physeq for aldex ------------------------------------------------------------


factors <- c("Illumina.Plate.Number", "Date.on.Sample", "dsex", "hisp_ethnicity", "race", "depression", "anxiety", "anhedonia", "mood")
